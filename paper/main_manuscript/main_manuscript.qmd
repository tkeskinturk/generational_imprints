...
Yet, taken on their own, each framework falls short of explaining persistent and directional change. If political sorting alone were sufficient, attitude shifts would persist so long as political messaging remained consistent, regardless of age---a pattern at odds with cohort-based cultural change [@kiley2020; @vaisey2016]. If cohort differentiation alone were sufficient, identities would be inconsequential and there would be no ground for directional change [@ryder1965].
...
This section integrates cohort differentiation and political sorting in a two-stage theory of opinionation. Applied to the case of attitudes toward law enforcement, these dynamics explain how salient political events have differential effects across age groups and prior political dispositions.
...
The dynamics of cohort differentiation and political sorting lead to several theoretical conclusions. While cohort differentiation provides an account for how political shocks affect younger individuals more strongly than older ones---thus addressing the *who* question---the political sorting clarifies the *direction* of change. That is, when changes in the political information environment prompt the younger cohorts to form and rework their attitudes, political sorting channels these developments into the political field, orienting people's positions in specific directions.

The two-stage model of generational imprinting synthesizes these two frameworks to explain how political events translate into durable and directional attitude change. In the first stage, individuals learn congenial cues from political allies, parties or movements[^porm], and update in specific directions. In the second stage, the trajectory of these initial update depends on one's life-course position: the Young retains the new stance while the Old gradually reverts to their pre‑event baseline. The model thus predicts differentially persistent identity-congenial opinion change---a pattern neither cohort differentiation, which says nothing about direction, nor political sorting, which says nothing about age-differential patterns of attitude persistence, can generate on its own.

[^porm]: Since the theoretical framework posits congenial messages as the engine of directional opinionation, the *source* of these messages can be political parties, social or political movements, or a combination of both. In that sense, it is possible to observe either an update to the initial position based on partisan cues, or partisan switching following the update. In both cases, the empirical patterns at the group level are observationally equivalent.
...
I now propose three expectations derived from these considerations. Following with the previous typology, the Young refers to younger age groups while the Old refers to older age groups. Again, these expectations consider a shock to the political information environment, rather than a gradual development. Figure 2 proposes a Directed Acyclic Graph (DAG) that incorporates the necessary elements for these expectations. The first expectation interacts cohort differentiation and political sorting, and suggests that updating depends on age group and political identity:
